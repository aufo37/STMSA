...
traindata = pickle.load(open('D:\STMSA_data\mosi/m00train3.pkl', 'rb'))
testdata  = pickle.load(open('D:\STMSA_data\mosi/m00test3.pkl', 'rb'))

# traindata = pickle.load(open('D:\STMSA_data\mosi/m25train3.pkl', 'rb'))
# testdata  = pickle.load(open('D:\STMSA_data\mosi/m25test3.pkl', 'rb'))
...
def train(sess, setting):
    ...
    with sess.as_default():
        ...
        #gradients = tf.gradients(m.total_loss, tf.trainable_variables())
        #clipped_grads, global_norm = tf.clip_by_global_norm(gradients,clip_norm=5.0)  # ‌:ml-citation{ref="1,5" data="citationList"}
        #train_op = optimizer.apply_gradients(zip(clipped_grads, tf.trainable_variables()), global_step=global_step)  # ‌:ml-citation{ref="2,3" data="citationList"}
        ...
        # new_saver = tf.train.import_meta_graph('./STMSA_model/MT_ATT_model-10.meta')
        # new_saver.restore(sess, './STMSA_model/MT_ATT_model-10')
...
def test(sess, setting):
    ...
    with sess.as_default():
        ...
        print('top 5 f1:', top_f1_5)
        print('top 5 acc:', top_acc_5)
